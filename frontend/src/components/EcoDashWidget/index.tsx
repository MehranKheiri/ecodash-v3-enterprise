...
export const EcoDashWidget: React.FC<EcoDashWidgetProps> = ({ projectId }) => {
    ...
    return (
        <>
            ...
            <div
                className="inline-block bg-white border border-gray-200 rounded-3xl px-5 py-3 shadow-sm hover:shadow-md transition-shadow duration-300 cursor-pointer z-40"
                onClick={() => setIsModalOpen(true)}
            >
                {/* Top row: project name, weather, AQI */}
                <div className="flex items-center gap-4 whitespace-nowrap">
                    ...
                    <div className="px-2.5 py-1 bg-gray-100 rounded-full text-xs font-medium text-gray-700 flex items-center gap-1">
                        {weather.temperature}&deg;C <span className="text-gray-400">|</span> {getWeatherDesc(weather.weatherCode)}
                    </div>
                ...
                {/* Always-visible details row */}
                <div className="pt-3 mt-3 border-t border-gray-100 grid grid-cols-2 gap-x-6 gap-y-1 min-w-[300px]">
                    <div className="text-xs text-gray-500 flex justify-between">PM2.5: <strong className="text-gray-700">{aqi.pm25} &micro;g/m&sup3;</strong></div>
                    ...
                    <div className="text-xs text-gray-500 flex justify-between">PM10: <strong className="text-gray-700">{aqi.pm10} &micro;g/m&sup3;</strong></div>
                ...
                <div className="text-[10px] text-gray-400 text-center mt-2 uppercase tracking-wider">Click for full transparency report</div>
            </div>
                    ...
                    <div className="bg-white rounded-3xl w-full max-w-5xl max-h-[90vh] overflow-y-auto shadow-2xl relative" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="p-10">
                            <div className="text-center mb-10">
                                <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight">{project.name} &mdash; Transparency Report</h2>
                                    ...
                                    <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                                        ...
                                        <div className="grid grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-sm text-gray-500 mt-1">CO&sup2; Emissions (Tons)</div>
                                            </div>
                                            <div>
                                                <div className="text-3xl font-bold text-gray-900">{project.waterM3}</div>
                                                <div className="text-sm text-gray-500 mt-1">Water Consumed (m&sup3;)</div>
                                            </div>
                                            <div>
                                    ...
                                    <div className={`${aqiInfo.bg} p-6 rounded-2xl border border-opacity-50`}>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex justify-between items-end">
                                                ...
                                                <span className={`text-lg font-semibold ${aqiInfo.color}`}>{aqi.pm25} <span className="text-xs">&micro;g/m&sup3;</span></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
